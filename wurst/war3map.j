...
// Trigger: Trenchs
//===========================================================================
function Trig_Trenchs_Conditions takes nothing returns boolean
...
function Trig_Trenchs_Actions takes nothing returns nothing
    call SetPlayerTechMaxAllowedSwap( 'o001', -1, GetOwningPlayer(GetTriggerUnit()) )
    call SetPlayerTechMaxAllowedSwap( 'h02T', 0, GetOwningPlayer(GetTriggerUnit()) )
endfunction

//===========================================================================
function InitTrig_Trenchs takes nothing returns nothing
    set gg_trg_Trenchs = CreateTrigger(  )
    call TriggerRegisterAnyUnitEventBJ( gg_trg_Trenchs, EVENT_PLAYER_UNIT_RESEARCH_FINISH )
    call TriggerAddCondition( gg_trg_Trenchs, Condition( function Trig_Trenchs_Conditions ) )
    call TriggerAddAction( gg_trg_Trenchs, function Trig_Trenchs_Actions )
endfunction

//===========================================================================
// Trigger: Avandazilla
//===========================================================================
function Trig_Avandazilla_Conditions takes nothing returns boolean
    if ( not ( GetUnitTypeId(GetConstructedStructure()) == 'h02T' ) ) then
        return false
    endif
    return true
endfunction

function Trig_Avandazilla_Actions takes nothing returns nothing
    call ReplaceUnitBJ( GetConstructedStructure(), 'h02R', bj_UNIT_STATE_METHOD_RELATIVE )
endfunction

//===========================================================================
function InitTrig_Avandazilla takes nothing returns nothing
    set gg_trg_Avandazilla = CreateTrigger(  )
    call TriggerRegisterAnyUnitEventBJ( gg_trg_Avandazilla, EVENT_PLAYER_UNIT_CONSTRUCT_FINISH )
    call TriggerAddCondition( gg_trg_Avandazilla, Condition( function Trig_Avandazilla_Conditions ) )
    call TriggerAddAction( gg_trg_Avandazilla, function Trig_Avandazilla_Actions )
endfunction

//===========================================================================
// Trigger: Destacamento
//===========================================================================
function Trig_Destacamento_Conditions takes nothing returns boolean
...
function Trig_Destacamento_Actions takes nothing returns nothing
    call ReplaceUnitBJ( GetTriggerUnit(), 'h02S', bj_UNIT_STATE_METHOD_RELATIVE )
endfunction

//===========================================================================
function InitTrig_Destacamento takes nothing returns nothing
    set gg_trg_Destacamento = CreateTrigger(  )
    call TriggerRegisterAnyUnitEventBJ( gg_trg_Destacamento, EVENT_PLAYER_UNIT_UPGRADE_FINISH )
    call TriggerAddCondition( gg_trg_Destacamento, Condition( function Trig_Destacamento_Conditions ) )
    call TriggerAddAction( gg_trg_Destacamento, function Trig_Destacamento_Actions )
endfunction
...
function Trig_Quests_Actions takes nothing returns nothing
    ...
    call CreateQuestBJ( bj_QUESTTYPE_OPT_DISCOVERED, "TRIGSTR_1690", "TRIGSTR_1691", "war3mapImported\\BTNSpanish_Home_City_3_(Blood_Brothers).blp" )
endfunction
...
function Trig_Cut_off_ration_Func001Func005C takes nothing returns boolean
    if ( not ( GetUnitTypeId(GetTrainedUnit()) == 'h020' ) ) then
        return false
    endif
    return true
endfunction
...
function Trig_Cut_off_ration_Func001Func011Func001C takes nothing returns boolean
...
function Trig_Cut_off_ration_Func001Func011C takes nothing returns boolean
    if ( not Trig_Cut_off_ration_Func001Func011Func001C() ) then
        return false
    endif
    return true
endfunction
...
function Trig_Cut_off_ration_Func001Func018C takes nothing returns boolean
...
function Trig_Cut_off_ration_Actions takes nothing returns nothing
    if ( Trig_Cut_off_ration_Func001C() ) then
        if ( Trig_Cut_off_ration_Func001Func001C() ) then
            ...
            call AdjustPlayerStateBJ( 19, GetOwningPlayer(GetTriggerUnit()), PLAYER_STATE_RESOURCE_LUMBER )
        else
            call DoNothing(  )
        endif
        ...
        if ( Trig_Cut_off_ration_Func001Func018C() ) then
            call AdjustPlayerStateBJ( 1, GetOwningPlayer(GetTriggerUnit()), PLAYER_STATE_RESOURCE_GOLD )
            call AdjustPlayerStateBJ( 1, GetOwningPlayer(GetTriggerUnit()), PLAYER_STATE_RESOURCE_LUMBER )
        else
            call DoNothing(  )
...
function InitCustomTriggers takes nothing returns nothing
    ...
    call InitTrig_Trenchs(  )
    call InitTrig_Avandazilla(  )
    call InitTrig_Destacamento(  )
